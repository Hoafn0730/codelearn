            ...
            <div class="row">
                <div class="col l-8 m-12 c-12">
                    <div class="courseDetail_wrapper">
                        ...
                        <div class="courseDetail_description">${foundObject.description}</div>
                        <div class="star">
                                ...
                                <li class="curriculum-item">
                                    ...
                                    <div class="curriculum_collapse">
                                        ${foundObject.lessions
                                            ? foundObject.lessions
                                                  .map((item, index) => {
                                                      return html` <div class="curriculum_lessionItem">
                        ...
                        <div class="courseDetail_description">
                            <h1>Mô tả</h1>
                            <p>
                                Next.JS là một framework javascript chuyên làm frontend, tích hợp sẵn thư viện React để
                                code giao diện UI một cách hiệu quả.<br />
                                Lợi thế của Next.js so với việc sử dụng React thuần túy, chính là việc cung cấp bộ khung
                                framework, giải quyết các vấn đề thường gặp của React mà bấy lâu nay chúng ta cần tự xử
                                lý, ví dụng như routing, nested route.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col l-4 m-12 c-12">
                    <div class="courseDetail_purchaseBadge">
                        <div class="courseDetail_preview">
                            <img src="${foundObject.image}" alt="" class="courseDetail_img" />
                        </div>
                        <div class="price">
